...
import { Scene, LineLayer, Marker, PointLayer, PolygonLayer } from '@antv/l7';
...
const Index: React.FC = () => {
  ...
  useEffect(() => {
    ...
    scene.on('loaded', () => {
      ...
      if (mapDom) mapDom.style.background = '#131722';
      ...
      pointData.forEach((item) => {
        ...
        const marker = new Marker({
          ...
          lat: parseFloat(String(item.latitude).trim()),
        });
      ...
      source
        ...
        .then((data) => {
          const newFeatures = data.features.filter((f) => f.properties.name);
          const newData = {
