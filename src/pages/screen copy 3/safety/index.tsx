       ...
       <div className='container'>
        {/* <Image src={back} width={'100%'} height={'100%'}/>  */}
          <div className="column column_left">
            <ItemCard title="风险信息" height={"18%"}>
              < RiskInfo />
            </ItemCard>
            <ItemCard title="风险处理工单" height={"39%"}>
              <RiskHandle />
            </ItemCard>
            <ItemCard title="今日工作人员统计" height={"35%"}>
              <TodayWorker />
            </ItemCard>
          </div>
          ...
          <div className="column column_right">
            <ItemCard title="环境监控" height={'48%'} extra={'按钮'}>UI还没切图</ItemCard>
            <ItemCard title="报警监控查询" height={'48%'}>UI还没切图</ItemCard>
          </div>
       </div>
  );
};
