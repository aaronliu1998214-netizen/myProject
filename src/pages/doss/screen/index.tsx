...
import Header from '@/pages/doss/screen/component/header';
import ItemCard from '@/pages/doss/screen/component/itemCard';
// import CenterComp from '@/pages/screen/component/center';
import CenterComp from '@/pages/doss/screen/component/center';
import SelectRadio from '@/pages/doss/screen/component/select';
import { getSummaryData } from '../screen/service';
import { enterFullScreen, exitFullScreen, isFullScreenNow } from '@/utils/fullscreen';

// 懒加载组件 - 只有在需要时才加载
const AttackAnalysis = lazy(() => import('@/pages/doss/screen/component/attackAnalysis'));
const Coprocessing = lazy(() => import('@/pages/doss/screen/component/coprocessing'));
const OverViewProtectedAssets = lazy(() => import('@/pages/doss/screen/component/overViewProtectedAssets'));
const ResourcesMonitor = lazy(() => import('@/pages/doss/screen/component/resourcesMonitor'));
const TreatIntell = lazy(() => import('@/pages/doss/screen/component/treatIntell'));
const Replay = lazy(() => import('@/pages/doss/screen/component/replay'));
const RealTimeAttack = lazy(() => import('@/pages/doss/screen/component/realTimeAttack'));
const EarthIndex = lazy(() => import('@/pages/doss/screen/component/earthIndex'));
const EarthModal = lazy(() => import('@/pages/doss/screen/component/earth'));
const MapModal = lazy(() => import('@/pages/doss/screen/component/chinaMap'));
...
const App: React.FC = () => {
  ...
  const handleFullscreenToggle = useCallback(() => {
    if (isBig) {
      history.push('/doss/screen');
    } else {
      history.push('/doss/screen_big');
    }
  }, [isBig]);
